...
<head>
    ...
    <link rel="stylesheet" href="css/DonorDonations.css?<?=filemtime("css/DonorDonations.css")?>">
</head>
<body>
    <div class="background">
        ...
        <main>
            <div class="content">
                ...
                <center><h3 class="heading">Your Donations: </h3></center>
                <hr>
                ...
                <?php
                    ...
                    $sql = $con->query("SELECT donor_id FROM donor WHERE donor_name= '$name'");

                    if($sql->num_rows > 0) {
                        $result_array = $sql->fetch_assoc();     // get record of the current donor
                        $id = $result_array["donor_id"];            // storing id of current donor

                        $result = $con->query("SELECT * FROM donation WHERE donor_id= '$id'");
                ...
                <?php if(isset($_SESSION["found"]) && $_SESSION["found"] !== '') {
                  ...
                  <?php } 
                } else if(isset($_SESSION["noRecordFound"]) && $_SESSION["noRecordFound"] !== '') { ?>
                    <div class="donor_img">
                        <p></p>
                    </div>
                    <div class="message">   
                        <p><?php echo $_SESSION["noRecordFound"]; ?></p>
                    </div> 
                 <?php }  ?>
