...
<head>
    ...
    <link rel="stylesheet" href="css/DonorSignupForm.css?<?=filemtime("css/DonorSignupForm.css")?>">
...
<body>
    <div class="background">
        ...
        <div class="signup-box">
            ...
            <form action="DonorSignup.php" method="POST" name="donorSignupForm">
                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="category" placeholder="Individual/Organization" required>
                    </div>

                    <div class="input-box">
                        <span class="details">Organization</span>
                        <input type="text" name="organization" placeholder="Organization/Individual Name" required>
                    </div>
